...
import ru.kulikov.enter.domain.use_cases.impl.ForgotUserUseCaseImpl
...
interface EnterModule {
    ...
    @Singleton
    @Binds
    fun bindForgotUserUseCase(forgotUserUseCase: ForgotUserUseCaseImpl): ForgotUserUseCase
}